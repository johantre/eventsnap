...
LLM_OPTIONS = [
    ...
    {"id": "claude", "label": "Claude", "sublabel": "Anthropic",     "env": "ANTHROPIC_API_KEY",
     "color": "#d97706", "cost": "coin", "cost_tip": "~0.01€/post · min. $5 opladen"},
    {"id": "openai", "label": "OpenAI", "sublabel": "GPT-4o",        "env": "OPENAI_API_KEY",
     "color": "#16a34a", "cost": "coin", "cost_tip": "~0.01€/post · min. $5 opladen"},
    {"id": "gemini", "label": "Gemini", "sublabel": "Google",        "env": "GEMINI_API_KEY",
